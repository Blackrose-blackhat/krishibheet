          ...
          <CardHeader>
            <CardTitle>
              <div className="flex flex-row items-center gap-3">
               ...
               <Image src={consumerLogo} height={32} width={42} alt="consumer" className="-mt-5" />
              </div> 
              </CardTitle>
            <CardDescription>
      ...
      <TabsContent value="seller">
        <Card className="p-5 shadow-xl shadow-neutral-800">
          <CardHeader>
            ...
            <div className="flex flex-row items-center gap-3">
                <p>Seller Account</p>
               <Image src={sellerLogo} height={32} width={92} alt="consumer" className="-mt-7"  />
              </div> 
            </CardTitle>
            <CardDescription>
          ...
          <CardContent className="space-y-2">
            <div className="space-y-1">
              ...
              <Input id="seller_email" type="email" placeholder="johndoe@example.com" />
            </div>
            <div className="space-y-1">
